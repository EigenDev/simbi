...
FIELD_MAP: dict[str, str] = {
    ...
    # reynolds-decomposition fluctuations: q' = q - <q>
    "delta_rho": r"$\delta \rho$",
    "delta_p": r"$\delta p$",
    "delta_chi": r"$\delta \chi$",
    "delta_v": r"$\delta |\mathbf{v}|$",
    "delta_v1": r"$\delta v_1$",
    "delta_v2": r"$\delta v_2$",
    "delta_v3": r"$\delta v_3$",
    "delta_mach": r"$\delta \mathcal{M}$",
    # relative fluctuations: (q - <q>) / <q>
    "delta_rel_rho": r"$\delta \rho / \langle \rho \rangle$",
    "delta_rel_p": r"$\delta p / \langle p \rangle$",
    "delta_rel_chi": r"$\delta \chi / \langle \chi \rangle$",
    "delta_rel_v": r"$\delta |\mathbf{v}| / \langle |\mathbf{v}| \rangle$",
    "delta_rel_v1": r"$\delta v_1 / \langle v_1 \rangle$",
    "delta_rel_v2": r"$\delta v_2 / \langle v_2 \rangle$",
    "delta_rel_v3": r"$\delta v_3 / \langle v_3 \rangle$",
    "torque x": r"$\tau_x$",
    "torque y": r"$\tau_y$",
    "torque z": r"$\tau_z$",
