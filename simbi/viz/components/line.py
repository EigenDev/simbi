...
def _update_line_data(line: Line2D, x_data: Array, y_data: Array):
    """Updates an existing line's data for animation."""
    line.set_data(x_data, y_data)


def _update_line_style(
    line: Line2D, style: dict[str, Any], label: Optional[str]
):
