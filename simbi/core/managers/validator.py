...
class ConfigValidator:
    ...
    def validate_regime(self, regime: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(None, ValueError(f"{e}. Available options: {Regime.list()}"))
    ...
    def validate_coord_system(self, coord_system: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(
                None, ValueError(f"{e}. Available options: {CoordSystem.list()}")
            )
    ...
    def validate_temporal_order(self, temporal_order: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(
                None, ValueError(f"{e}. Available options: {TimeStepping.list()}")
            )
    ...
    def validate_spatial_order(self, space_order: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(
                None, ValueError(f"{e}. Available options: {SpatialOrder.list()}")
            )
    ...
    def validate_spacing(self, cell_spacing: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(
                None, ValueError(f"{e}. Available options: {CellSpacing.list()}")
            )
    ...
    def validate_solver(self, solver: str) -> Maybe[str]:
        ...
        try:
            ...
            return Maybe(None, ValueError(f"{e}. Available options: {Solver.list()}"))
    ...
    def validate_boundary_conditions(
        ...
        try:
            ...
            return Maybe(
                None, ValueError(f"{e}. Available options: {BoundaryCondition.list()}")
            )
