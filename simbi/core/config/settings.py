...
class IOSettings(BaseSettings):
    ...
    def from_dict(cls, setup: dict[str, Any]) -> "IOSettings":
        return cls(
            ...
            hydro_expressions=setup.get("hydro_source_expressions"),
            gravity_expressions=setup.get("gravity_source_expressions"),
    ...
    def to_execution_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "hydro_source_expressions": self.hydro_expressions,
            "gravity_source_expressions": self.gravity_expressions,
