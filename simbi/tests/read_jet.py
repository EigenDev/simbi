...
def main():
    ...
    tend = t
    c1 = ax.pcolormesh(tt, rr, prim_dict[args.prim], cmap="rainbow", shading='auto', norm = norm)
    c2 = ax.pcolormesh(t2[::-1], rr, prim_dict[args.prim],  cmap="rainbow", shading='auto', norm = norm)
