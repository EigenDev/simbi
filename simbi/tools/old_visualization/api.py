...
def plot_line(
    ...
    **kwargs,
    ...
    # Add title component
    fig.add(
        TitleComponent, "title", setup=config["plot"]["setup"], ax_title=True
    )
                ...
                if kwargs.get("weight"):
                    ...
                    if weights is not None:
                        ...
                        if field in data.fields:
                            ...
                            var = np.sum(weights * var_data * dV) / np.sum(
                                weights * dV
                            )
