...
def set_axis_title(ax: Axes, title: Optional[str]) -> None:
...
def set_axis_limits(
    ...
    # Calculate margins
    x_margin_left, x_margin_right = calculate_margins(x_min, x_max, margin_percent)
    y_margin_bottom, y_margin_top = calculate_margins(y_min, y_max, margin_percent)
