...
namespace simbi::afterglow::constants {
    ...
    constexpr auto aRad     = 7.5646e-15 * units::erg / units::cm3 /
                          (units::kelvin * units::kelvin * units::kelvin * units::kelvin);
    constexpr auto sigma_boltzmann =
        5.67051e-5 * units::erg / units::cm2 /
        (units::kelvin * units::kelvin * units::kelvin * units::kelvin);
