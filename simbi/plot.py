...
def parse_plotting_arguments(parser: argparse.ArgumentParser) -> argparse.Namespace:
    ...
    plot_parser.add_argument('setup',        type=str, help='The name of the setup being plotted')
    plot_parser.add_argument('--fields',     default=['rho'], nargs='+', help='the name of the field variable',choices=field_choices)
    plot_parser.add_argument('--xmax',       default = 0.0, help='the domain range')
    plot_parser.add_argument('--log',        default=False, action='store_true',  help='logarithmic plotting scale')
    ...
    plot_parser.add_argument('--norm',       default=False, action='store_true', help='flag to normalize plot axes')
    plot_parser.add_argument('--labels',     default = None, nargs='+', help='list of legend labels')
    plot_parser.add_argument('--xlims',      default = None, type=float, nargs=2, help='limits of x axis')
    plot_parser.add_argument('--ylims',      default = None, type=float, nargs=2, help='limits of y axis')
    plot_parser.add_argument('--units',      default = False, action='store_true', help='flag for dimensionful units')
    plot_parser.add_argument('--power',      default = 1.0, type=float, help='exponent of power-law norm')
    plot_parser.add_argument('--dbg',        default = False, action='store_true', help='flag for dark background style')
    plot_parser.add_argument('--tex',        default = False, action='store_true', help='flag for latex typesetting')
    plot_parser.add_argument('--print',      default = False, action='store_true', help='flag for publications plot formatting')
    plot_parser.add_argument('--pictorial',  default = False, action='store_true', help='flag for creating figs without data')
    plot_parser.add_argument('--anot_loc',   default = None, type=str, help='location of annotations', choices=['lower_left', 'lower_right', 'upper_left', 'upper_right', 'upper_center', 'lower_center', 'center'])
    plot_parser.add_argument('--legend_loc', default = None, type=str, help='location of legend', choices=['lower_left', 'lower_right', 'upper_left', 'upper_right', 'upper_center', 'lower_center', 'center'])
    plot_parser.add_argument('--anot_text',  default = None, type=str, help='text in annotations')
    plot_parser.add_argument('--inset',      default=False, action= 'store_true', help='flag for inset plot')
    plot_parser.add_argument('--png',        default=False, action= 'store_true', help='flag for saving figure as png')
    plot_parser.add_argument('--fig_dims',   default = [4, 4], type=float, nargs=2, help='figure dimensions')
    plot_parser.add_argument('--legend',     default=True, action=argparse.BooleanOptionalAction, help='flag for legend output')
    ...
    plot_parser.add_argument('--kind',       default='snapshot', type=str, choices=['snapsoht', 'movie'], help='kind of visual to output')
