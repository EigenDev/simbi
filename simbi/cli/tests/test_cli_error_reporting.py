# =============================================================================
# test_cli_error_reporting.py
#
# regression gates for CLI error reporting: an unregistered or mistyped command
# must fail fast with the real message and exit 2, without the error handler
# re-entering parsing; flag errors exit 2, never 0; the analysis CLI reports
...
def test_bare_run_parses_and_defers_to_the_executor(capsys):
    ...
    # the parser level); the executor owns the missing-config error. the parser
    # must not re-parse into --help and exit 0.
