...
u = bm.simulate(tend = tend,dt=dt, coordinates=b"spherical", first_order=True, CFL=0.1)

yamma = W(u[2])/np.sqrt(2)

fig, ax = plt.subplots(1, 1, figsize=(10, 15))

ax.plot(r, rho*gammas**2, '--',  label='$t_0$')
ax.plot(r, u[0]*yamma**2, label='$(t_0 + dt)$')
ax.plot(r, u[2], label='$v$')
