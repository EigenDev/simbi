...
namespace simbi {
    namespace io {
        ...
        int TerminalCapabilities::get_terminal_width()
        {
#ifdef _WIN32
        ...
        ) const
        {
            ...
            for (size_t i = 0; i < column_widths.size(); ++i) {
                int line_length = column_widths[i] + (2 * theme_config.padding);
        ...
        ) const
        {
            ...
            for (size_t i = 0; i < column_widths.size(); ++i) {
                ...
                // left padding
                for (int p = 0; p < theme_config.padding; ++p) {
                    os << " ";
                }
        ...
        void Table::print_title_section(std::ostream& os) const
        {
            ...
            for (int i = 0; i < theme_config.title_spacing; ++i) {
                os << "\n";
            }
        }
        ...
        void Table::print_footer_section(std::ostream& os) const
        {
            ...
            // add spacing
            for (int i = 0; i < theme_config.section_spacing; ++i) {
                os << "\n";
            }
        ...
        int TerminalCapabilities::get_terminal_height()
        {
#ifdef _WIN32
            CONSOLE_SCREEN_BUFFER_INFO csbi;
            if (GetConsoleScreenBufferInfo(
        ...
        void Table::set_column_width(size_t col_index, int width)
        {
        ...
        void Table::set_min_column_width(size_t col_index, int min_width)
        {
        ...
        void Table::set_max_column_width(size_t col_index, int max_width)
        {
        ...
        void Table::set_max_table_width(int width)
        {
        ...
        void Table::set_progress(int percent)
        {
        ...
        ) const
        {
            ...
            for (size_t i = 0; i < column_widths.size(); ++i) {
                for (int j = 0; j < column_widths[i] + 2 * theme_config.padding;
                     ++j) {
        ...
        void Table::print_progress_row(std::ostream& os) const
        {
            ...
            size_t total_width = calculate_total_width();
            int bar_width      = static_cast<int>(total_width) -
                            2;   // account for left/right borders
            int pos = bar_width * progress_percent / 100;

            // print T-joint separator before progress bar
            os << get_color_code(theme_config.border_color);
        ...
        void Table::refresh()
        {
            // for dynamic tables, just call print which handles screen clearing
            print();
        }
