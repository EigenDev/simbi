...
namespace simbi {
    namespace io {
        ...
        enum class DisplayMode {
            Static,   // print once at current cursor position
        ...
        class Table
        {
          private:
            ...
            std::vector<int> min_column_widths;
            std::vector<int> max_column_widths;
            ...
            int max_table_width       = 0;   // 0 = no limit
          ...
          public:
            ...
            void set_column_width(size_t col_index, int width);
            void set_min_column_width(size_t col_index, int min_width);
            void set_max_column_width(size_t col_index, int max_width);
            ...
            void set_max_table_width(int width);
