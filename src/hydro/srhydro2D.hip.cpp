            ...
            if (n >= nfold){
                ...
                zu_avg += total_zones / delta_t;
                 if constexpr(BuildPlatform == Platform::GPU) {
                    ...
                    writefl("\riteration:{:>06} dt:{:>08.2e} time:{:>08.2e} zones/sec:{:>08.2e} ebw(%):{:>04.2f}", n, dt, t, total_zones/delta_t, static_cast<real>(100.0) * gtx_emperical_bw / gpu_theoretical_bw);
                } else {
