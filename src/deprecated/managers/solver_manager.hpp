...
namespace simbi {
    ...
    class SolverManager
    {
      ...
      public:
        ...
        DUAL auto reconstruction() const { return reconstruction_; }
        DUAL auto timestepping() const { return timestepping_; }
