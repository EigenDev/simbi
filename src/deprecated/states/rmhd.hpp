    ...
    class RMHD : public HydroBase<RMHD<dim>, dim, Regime::RMHD>
    {
      ...
      public:
        ...
        using ct_scheme_t = std::conditional_t<
            comp_ct_type == CTAlgo::MdZ,
            ct::CTMdZ,
            std::conditional_t<
                comp_ct_type == CTAlgo::ZERO,
                ct::CTZero,
                ct::CTContact>>;
        ...
        /* Shared Data Members */
        ndarray_t<conserved_t, dim> fri, gri, hri;
        ndarray_t<real, dim> bstag1, bstag2, bstag3;
        ndarray_t<real, dim> bstag1_old, bstag2_old, bstag3_old;
