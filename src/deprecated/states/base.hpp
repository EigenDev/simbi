...
namespace simbi {
    ...
    class HydroBase : public Managed<global::managed_memory>
    {
      ...
      protected:
        ...
        ndarray_t<Maybe<primitive_t>, Dims> prims_;
        ndarray_t<conserved_t, Dims> cons_;
      ...
      protected:
        ...
        // fmr-related members
        struct level_data_t {
            ndarray_t<Maybe<primitive_t>, Dims> prims;
            ndarray_t<conserved_t, Dims> cons;
        };
        ...
        HydroBase(
            ndarray_t<conserved_t, Dims>&& init_conserved,
            ndarray_t<Maybe<primitive_t>, Dims>&& init_primitives,
        ...
        const ndarray_t<conserved_t, Dims>&
        level_conserved(size_type level) const
        {
        ...
        const ndarray_t<Maybe<primitive_t>, Dims>&
      ...
      public:
        ...
        auto reconstruction() const { return solver_config_.reconstruction(); }
        auto timestepping() const { return solver_config_.timestepping(); }
