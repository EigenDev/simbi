    ...
    namespace helpers {
                        ...
                        switch (geometry) {
                            case simbi::Geometry::SPHERICAL:
                                ...
                                cons[1 * sx + (ii + 2) * sy] =
                                    cons[2 * sx + (ii + 2) * sy];
                                cons[(x2grid_size - 1) * sx + (ii + 2) * sy] =
                                    cons[(x2grid_size - 4) * sx +
                                         (ii + 2) * sy];
                                cons[(x2grid_size - 2) * sx + (ii + 2) * sy] =
                                    cons[(x2grid_size - 3) * sx +
                                         (ii + 2) * sy];
                                if (half_sphere) {
                                    cons[(x2grid_size - 1) * sx + (ii + 2) * sy]
                                        .momentum(2) *= -1;
                            ...
                            default:
                                switch (boundary_conditions[2]) {
                                    case simbi::BoundaryCondition::REFLECTING:
                                        ...
                                        cons[1 * sx + (ii + 2) * sy] =
                                            cons[2 * sx + (ii + 2) * sy];
                                        cons[0 * sx + (ii + 2) * sy].momentum(
                                            2) *= -1;
                                        cons[1 * sx + (ii + 2) * sy].momentum(
                                            2) *= -1;
                                        break;
                                    case simbi::BoundaryCondition::INFLOW:
                                        cons[0 * sx + (ii + 2) * sy] =
                        ...
                        switch (geometry) {
                            case simbi::Geometry::SPHERICAL:
                                cons[0 * sx * sy + (jj + 1) * sx + (ii + 1)] =
                                    cons[(x3grid_size - 2) * sx * sy +
                                         (jj + 1) * sx + (ii + 1)];
                                cons[(x3grid_size - 1) * sx * sy +
                                     (jj + 1) * sx + (ii + 1)] =
                                    cons[1 * sx * sy + (jj + 1) * sx +
                                         (ii + 1)];
                                break;
                            default:
                                switch (boundary_conditions[4]) {
                                    case simbi::BoundaryCondition::REFLECTING:
                                        cons[0 * sx * sy + (jj + 1) * sx +
                                             (ii + 1)] =
                                            cons[1 * sx * sy + (jj + 1) * sx +
                                                 (ii + 1)];
                                        cons[0 * sx * sy + (jj + 1) * sx +
                        ...
                        switch (geometry) {
                            case simbi::Geometry::SPHERICAL:
                                cons[(kk + 2) * sx * sy + 0 * sx + (ii + 2)] =
                                    cons[(kk + 2) * sx * sy + 3 * sx +
                                         (ii + 2)];
                                cons[(kk + 2) * sx * sy + 1 * sx + (ii + 2)] =
                                    cons[(kk + 2) * sx * sy + 2 * sx +
                                         (ii + 2)];
                                cons[(kk + 2) * sx * sy +
                            ...
                            default:
                                switch (boundary_conditions[2]) {
                                    case simbi::BoundaryCondition::REFLECTING:
                                        cons[(kk + 2) * sx * sy + 0 * sx +
                                             (ii + 2)] =
                                            cons[(kk + 2) * sx * sy + 3 * sx +
                                                 (ii + 2)];
                                        cons[(kk + 2) * sx * sy + 1 * sx +
                                             (ii + 2)] =
                                            cons[(kk + 2) * sx * sy + 2 * sx +
                                                 (ii + 2)];
                                        cons[(kk + 2) * sx * sy + 0 * sx +
                        ...
                        switch (geometry) {
                            case simbi::Geometry::SPHERICAL:
                                cons[0 * sx * sy + (jj + 2) * sx + (ii + 2)] =
                                    cons[(x3grid_size - 4) * sx * sy +
                                         (jj + 2) * sx + (ii + 2)];
                                cons[1 * sx * sy + (jj + 2) * sx + (ii + 2)] =
                                    cons[(x3grid_size - 3) * sx * sy +
                                         (jj + 2) * sx + (ii + 2)];
                                cons[(x3grid_size - 1) * sx * sy +
                                     (jj + 2) * sx + (ii + 2)] =
                                    cons[3 * sx * sy + (jj + 2) * sx +
                                         (ii + 2)];
                                cons[(x3grid_size - 2) * sx * sy +
                                     (jj + 2) * sx + (ii + 2)] =
                                    cons[2 * sx * sy + (jj + 2) * sx +
                                         (ii + 2)];
                                break;
                            default:
                                switch (boundary_conditions[4]) {
                                    case simbi::BoundaryCondition::REFLECTING:
                                        cons[0 * sx * sy + (jj + 2) * sx +
                                             (ii + 2)] =
                                            cons[3 * sx * sy + (jj + 2) * sx +
                                                 (ii + 2)];
                                        cons[1 * sx * sy + (jj + 2) * sx +
                                             (ii + 2)] =
                                            cons[2 * sx * sy + (jj + 2) * sx +
                                                 (ii + 2)];
                                        cons[0 * sx * sy + (jj + 2) * sx +
        ...
        compute_dt(U* self, const V* prim_buffer, real* dt_min)
        {
            ...
            if (ii < self->active_zones) {
                ...
                const real cfl_dt =
                    dx1 / (helpers::my_max(std::abs(vPlus + vfaceR),
                   ...
                   const simbi::Geometry geometry)
        {
            ...
            if ((ii < self->xactive_grid) && (jj < self->yactive_grid) &&
                    ...
                    case simbi::Geometry::CARTESIAN:
                        {
                            ...
                            cfl_dt = helpers::my_min3(
                                dx1 / (helpers::my_max(std::abs(plus_v1),
                                                       std::abs(minus_v1))),
                                dx2 / (helpers::my_max(std::abs(plus_v2),
                                                       std::abs(minus_v2))),
                                dx3 / (helpers::my_max(std::abs(plus_v3),
                                                       std::abs(minus_v3))));
                            break;
                        }
                    case simbi::Geometry::SPHERICAL:
                        {
                            ...
                            cfl_dt        = helpers::my_min3(
                                dx1 / (helpers::my_max(std::abs(plus_v1),
                                                       std::abs(minus_v1))),
                                rmean * dx2 /
                                    (helpers::my_max(std::abs(plus_v2),
                                                     std::abs(minus_v2))),
                                rmean * std::sin(th) * dx3 /
                                    (helpers::my_max(std::abs(plus_v3),
                                                     std::abs(minus_v3))));
                            break;
                        }
                    case simbi::Geometry::CYLINDRICAL:
                ...
                dt_min[kk * self->xactive_grid * self->yactive_grid +
                       jj * self->xactive_grid + ii] = self->cfl * cfl_dt;
            }
#endif
        }
            ...
            compute_dt(U* self, const V* prim_buffer, real* dt_min)
        {
            ...
            if (ii < self->active_zones) {
                if constexpr (is_relativistic_mhd<T>::value) {
                    if constexpr (dt_type == TIMESTEP_TYPE::ADAPTIVE) {
                        real cs, speeds[4];
                        self->calc_max_wave_speeds(prim_buffer[aid],
                                                   1,
                                                   speeds,
                                                   cs);
        ...
        GPU_LAUNCHABLE void deviceReduceKernel(T* self, real* dt_min, lint nmax)
        {
            ...
            if constexpr (dim == 1) {
                ...
                gid = self->yactive_grid * self->xactive_grid * kk +
                      self->xactive_grid * jj + ii;
            }
        ...
        GPU_CALLABLE int quartic(T b, T c, T d, T e, T res[4])
        {
            ...
            T m = cubic<real>(p,
                              0.25 * p * p + 0.01171875 * b * b * b * b - e +
                                  0.25 * b * d - 0.0625 * b * b * c,
                              -0.125 * q * q);
            if (q == 0.0) {
                if (m < 0.0) {
                    return 0;
