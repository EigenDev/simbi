#ifndef HET_CORE_ERROR_HANDLING_HPP
#define HET_CORE_ERROR_HANDLING_HPP
...
namespace simbi::het {
    ...
    struct error_translator_t {
        static status_t translate(auto)                = delete;
        static void check_and_throw(auto, const char*) = delete;
    };
