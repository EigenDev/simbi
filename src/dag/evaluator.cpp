...
namespace simbi::expression {
    ...
    )
    {
        ...
        for (std::uint64_t ii = 0; ii < output_count; ii++) {
            std::int64_t reg_idx = mapped_output_indices[ii];
    ...
    )
    {
        ...
        constexpr std::int64_t MAX_NODES = 1024;
        // max number of nodes in evaluation stack
        constexpr std::int64_t MAX_STACK = 64;
