...
// evaluator.hpp
//
// provides functions to evaluate expression dags.
// this file declares various functions to walk the expression tree (dag) and
// compute the final result. it includes recursive, non-recursive (stack-based),
// batch, and vectorized evaluation strategies, as well as an evaluator for
// the linearized instruction format.
//
// usage:
//   real result = evaluate_expr(nodes, root_idx, x1, x2, x3, t, params);
// =============================================================================
#pragma once
