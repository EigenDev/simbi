    ...
    fn in_place_buffer_is_a_single_mut_slice() {
        ...
        let desc = emit_kernel_cpu(
            ...
            &KernelEmitInputs {
                ...
                scalar_params: &[],
                field_writes: &[crate::gv::KernelWrite::new("rho", "cons.den", rho)],
                coord_components: &[],
                device_preamble: &[],
                tile_spec: None,
            },
    ...
    fn i32_scalar_param_emits_an_integer_signature() {
        ...
        let desc = emit_kernel_cpu(
            ...
            &KernelEmitInputs {
                ...
                field_writes: &[crate::gv::KernelWrite::new("out", "out", rho)],
                coord_components: &[],
                device_preamble: &[],
                tile_spec: None,
            },
    ...
    fn param_invariant_select_unswitches_into_two_specializations() {
        ...
        let desc = emit_kernel_cpu(
            ...
            &KernelEmitInputs {
                ...
                field_writes: &[crate::gv::KernelWrite::new("out", "out", acc)],
                coord_components: &[],
                device_preamble: &[],
                tile_spec: None,
            },
