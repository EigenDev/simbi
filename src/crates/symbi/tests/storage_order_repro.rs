...
//   3. derived: which axis lives "next to itself" in memory (= the fastest)?
//   4. derived: a CUDA warp launched with `threadIdx.x` mapped to axis 0
//      reads cells at what memory addresses? are they contiguous?
//
