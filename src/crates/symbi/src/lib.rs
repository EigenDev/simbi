...
// support utilities live in the `symbi-substrate` crate now (docs/design/41 step 3);
// re-exported at the historical `crate::regimes` / `crate::kernels` paths so evolve,
