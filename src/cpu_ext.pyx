...
cdef class SimState:
    ...
    def run(
        ...
        *,
        ...
        sim_cond.tstart           = <double>sim_info.get('tstart', 0.0)
        sim_cond.chkpt_interval   = <double>sim_info.get('chkpt_interval', 0.0)
        ...
        sim_cond.object_cells     = <vector[bool]>sim_info.get('object_cells', [False])
        ...
        sim_cond.x1               = <vector[real]>sim_info.get('x1', [0.0, 1.0])
        ...
        sim_cond.chkpt_idx           = <int>sim_info.get('chkpt_idx', 0)
        sim_cond.constant_sources    = <bool>sim_info.get('constant_sources', False)
