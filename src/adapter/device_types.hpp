    ...
    namespace grid {
        ...
        class execution_index
        {
          ...
          public:
            ...
            DUAL unsigned int block_x() const { return block_idx_.x; }
            DUAL unsigned int block_y() const { return block_idx_.y; }
            DUAL unsigned int block_z() const { return block_idx_.z; }

            DUAL unsigned int thread_x() const { return thread_idx_.x; }
            DUAL unsigned int thread_y() const { return thread_idx_.y; }
            DUAL unsigned int thread_z() const { return thread_idx_.z; }

            DUAL unsigned int block_dim_x() const { return block_dim_.x; }
            DUAL unsigned int block_dim_y() const { return block_dim_.y; }
            DUAL unsigned int block_dim_z() const { return block_dim_.z; }

            DUAL unsigned int grid_dim_x() const { return grid_dim_.x; }
            DUAL unsigned int grid_dim_y() const { return grid_dim_.y; }
            DUAL unsigned int grid_dim_z() const { return grid_dim_.z; }
            ...
            DUAL unsigned int global_thread_id() const
            {
        ...
        {
            unsigned int x = (total_elements + block.x - 1) / block.x;
...
// HIP specialization - only compiled when HIP is enabled
        ...
        {
          private:
            int value;   // HIP uses int-based atomics
