...
h = hydro2.simulate(tend=tend, first_order=True,  cfl=0.2, hllc=True , compute_mode=mode, boundary_condition='periodic')
u = hydro.simulate(tend=tend,  first_order=True,  cfl=0.2, hllc=False, compute_mode=mode, boundary_condition='periodic')
...
axs[0].set_title('1D Relativistic Blast Wave with N={} at t = {} (Marti & Muller 1999, Problem 1)'.format(N, tend), fontsize=10)
