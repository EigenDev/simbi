...
std::map<std::string, simbi::BoundaryCondition> boundary_map;
void config_system() {
    geometry["cartesian"]      = simbi::Geometry::CARTESIAN;
    geometry["spherical"]      = simbi::Geometry::SPHERICAL;
    boundary_map["reflecting"] = simbi::BoundaryCondition::REFLECTING;
    boundary_map["inflow"]     = simbi::BoundaryCondition::INFLOW;
    boundary_map["outflow"]    = simbi::BoundaryCondition::OUTFLOW;
}
