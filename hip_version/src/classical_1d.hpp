...
*/
#ifndef CLASSICAL_1D_HPP
#define CLASSICAL_1D_HPP
...
namespace simbi {
    ...
    class Newtonian1D {
        public: 
            ...
            Newtonian1D();
            Newtonian1D(std:: vector <std::vector <real> > init_state, 
                        real gamma, real CFL,std::vector<real> r, 
                        std::string coord_system);
            ~Newtonian1D();
            ...
            real adapt_dt(std::vector<hydro1d::Primitive> &prims);
